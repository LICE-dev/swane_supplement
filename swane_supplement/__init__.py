...
binary_cerebellum = os.path.abspath(os.path.join(os.path.dirname(__file__), "resources/FLAT1/binary_cerebellum.nii.gz"))
cortex_mas = os.path.abspath(os.path.join(os.path.dirname(__file__), "resources/FLAT1/brain_cortex_mas_OK.nii.gz"))
mean_extension = os.path.abspath(os.path.join(os.path.dirname(__file__), "resources/FLAT1/mean_extension.nii.gz"))
mean_flair = os.path.abspath(os.path.join(os.path.dirname(__file__), "resources/FLAT1/mean_flair.nii.gz"))
